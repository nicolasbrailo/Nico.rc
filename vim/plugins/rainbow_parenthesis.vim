" Copypasted from here, because I couldn't make it work with the structure of
" a git submodule
" https://github.com/junegunn/rainbow_parentheses.vim/blob/master/autoload/rainbow_parentheses.vim
...
function! RainPar_activate(...)
  ...
  augroup rainbow_parentheses
    autocmd!
    autocmd ColorScheme,Syntax * call RainPar_activate(1)
  augroup END
  let b:rainbow_enabled = s:generation
endfunction

function! RainPar_deactivate()
...
function! RainPar_toggle()
  if exists('#rainbow_parentheses')
    call RainPar_deactivate()
  else
    call RainPar_activate()
  endif
endfunction
